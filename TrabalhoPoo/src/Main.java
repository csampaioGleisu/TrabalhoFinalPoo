...
public class Main {
    public static void main(String[] args) throws VerificarSenha, ErroSenhaCliente, IndexOutOfBoundsException, InputMismatchException, InputMismatchException {
        ...
        while (op != 9) {
            System.out.println("Digite 1 para Adicionar um Administrador");
            System.out.println("Digite 2 para Entrar como Administrador");
            System.out.println("Digite 3 para Fazer Cadastro Cliente");
            System.out.println("Digite 4 para Comprar");
            ...
            if (op == 1) {
                ...
                String testeadm = scn.next();
                if (testeadm.equalsIgnoreCase("adm")) {
                    System.out.println("\"Senha correta!!! Bem vindo(a)!!!\"");

                    System.out.println("adicionar um novo adm");
                    try {
                        Adm.addAdms();
                    } catch (InputMismatchException e) {
                        System.err.println("O adm ja existe");
                    }
                    }else{
                        try {
                        ...
                        do {
                            System.out.println(Adm.IdsAdm);
                            System.out.println("Digite seu codigo de administrador:");
                            String codigoadm = scn.next();
                            if (Adm.IdsAdm.contains(codigoadm)) {
                                System.out.println("Digite a senha de administrador:");
